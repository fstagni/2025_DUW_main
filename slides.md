...
- LHCb migrated to DIRAC v9 + DiracX 0.0.1 (alpha) back in April
  ...
  - finally installed LHCbDIRAC v12.0 (on DIRAC v9.0) and lhcbdiracx 0.0.1 (on diracx 0.0.1)
    - also lhcbdiracx-web
